...
public class Graph {
	...
	public void depthFirstSearch(int source, boolean[] visited, int main) {
		...
		for (int adjascent : verticies.get(source))
			if (visited[adjascent] == false)
				depthFirstSearch(adjascent, visited, source);

	}

	public void breadthFirstsearch(int source, boolean[] visited) {
		visited[source] = true;
	...
	public static void main(String[] args) {
		...
		// undirected.depthFirstSearch(0, visited, 0);
		// System.out.println(" ");
